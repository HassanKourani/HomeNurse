...
type DatabaseResponse = {
  id: string;
  service_type: Array<"physiotherapy">;
  details: string;
  ...
  const fetchRequests = async () => {
    try {
      ...
      let query = supabase
        ...
        .overlaps("service_type", ["physiotherapy"])
    ...
    >
      <HeaderSection>
        <div className="title-section">
          <Title level={2}>Physiotherapy Requests</Title>
          <Text>View and manage physiotherapy service requests</Text>
        </div>
